...
frappe.pages['medical-reports'].on_page_load = function(wrapper) {
	...
	function get_patient_visit(loading = 0){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_patient_visit", //dotted path to server method
	...
	function get_report_doctor_wise_visit(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_doctor_wise_visit", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_report_diagnose(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_diagnose", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_report_lab(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_lab", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_report_radiolgy(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_radiolgy", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_report_inpatient(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_inpatient", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_theater(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_theater", //dotted path to server method
			args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
	...
	function get_hmtl_sales(){
		...
		frappe.call({
			method: "mma_design.api.medical_report.get_report_design", //dotted path to server method
			args : {"loading" : 1},
			//  args : {"load_a" : currdate , to_date : to_date},
			callback: function(r) {
