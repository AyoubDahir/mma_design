...
function get_inpatient_due_admited(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_inpatient_due", //dotted path to server method
...
function get_report_descount(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_descount", //dotted path to server method
...
function get_hmtl_sales(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_sales", //dotted path to server method
		args : {"loading" : 1},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function print_dy_report(loading = 0){
	frappe.call({
		method: "mma_design.api.api.get_report_design", //dotted path to server method
...
function get_report_sales(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_sales", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date.toString() , "to_date" : t_date.toString()},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_report_sales_return(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_sales_return", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_report_reciept(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_reciept", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_commission_due(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_commission_due", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_payable_summary(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_payable_summary", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_opd_sales_report(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_opd_sales_report", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function get_report_purchase_anaylsis(loading = 0){
	...
	frappe.call({
		method: "mma_design.api.api.get_report_purchase_anaylsis", //dotted path to server method
		args : {"loading" : loading , "from_date" : f_date , "to_date" : t_date},
		//  args : {"load_a" : currdate , to_date : to_date},
		callback: function(r) {
...
function prepare_layout(){
	...
	<div class="links">
	  ...
	  <a href="#" class="link">
		...
		<span onclick="get_report_sales_return()">Refund</span>
	  </a>
	  <a href="#" class="link">
